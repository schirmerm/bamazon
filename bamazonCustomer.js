    ...
    .then(({item_number, quantity}) => {
        switch(item_number){
            ...
            case '2':
                    ...
                    }else{console.log(`Sorry we have insufficient quantity of that item we only have ${data[1].stock_quantity}`)}
                    db.end()
                break
            ...
            case '3':
                    ...
                    }else{console.log(`Sorry we have insufficient quantity of that item we only have ${data[2].stock_quantity}`)}
                    db.end()
                break
            case '4':
                    ...
                    }else{console.log(`Sorry we have insufficient quantity of that item we only have ${data[3].stock_quantity}`)}
                    db.end()
                break
            case '5':
                    ...
                    }else{console.log(`Sorry we have insufficient quantity of that item we only have ${data[4].stock_quantity}`)}
                    db.end()
                break
            case '6':
                    ...
                    }else{console.log(`Sorry we have insufficient quantity of that item we only have ${data[5].stock_quantity}`)}
                    db.end()
                break
            case '7':
                    ...
                    }else{console.log(`Sorry we have insufficient quantity of that item we only have ${data[6].stock_quantity}`)}
                    db.end()
                break
            case '8':
                    ...
                    }else{console.log(`Sorry we have insufficient quantity of that item we only have ${data[7].stock_quantity}`)}
                    db.end()
                break
            case '9':
                    ...
                    }else{console.log(`Sorry we have insufficient quantity of that item we only have ${data[8].stock_quantity}`)}
                    db.end()
                break
            case '1o':
                    ...
                    }else{console.log(`Sorry we have insufficient quantity of that item we only have ${data[9].stock_quantity}`)
                    db.end()
                }
